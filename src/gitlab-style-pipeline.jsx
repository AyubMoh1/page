      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-800 rounded-lg p-6 border border-slate-700 mb-8">
          <p className="text-gray-300 mb-4">
            Building robust test automation frameworks for web, mobile, and API testing. Experienced with Selenium, Cypress, Playwright, and modern CI/CD pipelines.
          </p>
          <p className="text-gray-300">
            Specializing in Python, JavaScript, and TypeScript with a focus on maintainable, scalable test suites that enable teams to ship with confidence.
          </p>
        </div>
